	...
	ko.bindingHandlers.direction = {
		init: function(element, valueAccessor, allBindings, viewModel, bindingContext) {
			...
			if (to != null) {
				...
				L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoib2tyeXpoYW5pdnNreWkiLCJhIjoiY2oyb2xhcHA0MDAyOTJxcGZrdHQ4ZG0xZyJ9.7h-IQAfbm-AxbXAhEo5grw', {
